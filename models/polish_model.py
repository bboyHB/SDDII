...
class PolishModel(BaseModel):
    """ This class implements the polish model, for learning a mapping from input images to output images without paired data.
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['real_A', 'fake_B', 'real_B', 'diff_AB']
    ...
    def forward(self):
        ...
        self.diff_AB = torch.sum(torch.abs(self.fake_B.detach() - self.real_A.detach()), dim=1).unsqueeze(0) / 3.0 - 1.0
