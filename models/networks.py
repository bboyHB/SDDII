...
def define_G(input_nc, output_nc, ngf, netG, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    if netG == 'resnet_9blocks':
        ...
        net = VanillaGenerator(output_nc, 9, ngf, norm_layer=norm_layer, use_dropout=use_dropout)
    else:
...
class VanillaGenerator(nn.Module):
    def __init__(self, image_nc=3, num_ups=9, ngf=64, norm_layer=nn.BatchNorm2d, use_dropout=False):
